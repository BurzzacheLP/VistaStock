...
{
    public class buscarProveedorRazonSocial
    {
        public DataTable EjecutarYDevolver(string textobuscar)
        {
            ...
            return ejecutar_Procedimientos__Almacenados.EjecutarProcedimientoYDevolverDataTable("spbuscar_proveedor_razon_social", parametros);
        }
    }
}
