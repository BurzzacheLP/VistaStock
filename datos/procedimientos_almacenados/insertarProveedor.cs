...
namespace datos.procedimientos_almacenados
{
    ...
    {
        public bool EjecutarYDevolver(string localidad, string nombre, string razonsocial, string sectorcomercial, string tipodocumento, string numdocumento, string calle, int altura, string telefono, string gmail, string tipotelefono)
        {
            try
            {
